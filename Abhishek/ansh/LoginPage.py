...
class Login:
    ...
    #Tittle 
        title  = Label(Frame_login ,text="Login Page",font = ("impact",35,"bold"),fg="#6162FF").place(x=90,y=30)    
    ...
    # forgetpassword
        forgetpassword = Button(Frame_login ,text="Forget Password",font = ("Goudy old style",12),fg="#6162FF",bg="white").place(x=90,y=280)
        
        submitbutton = Button(Frame_login,command=self.check_function ,text="Login",font = ("Goudy old style",15),bg="#6162FF",fg="white").place(x=90,y=320,width=180,height=40)
        CreateAccount = Button(Frame_login ,text="Create New Account",font = ("Goudy old style",12),fg="#6162FF",bg="white").place(x=240,y=280)        
    def check_function(self):
        ...
        elif self.username.get()!="Abhishek" or self.password.get()!="12345" :
